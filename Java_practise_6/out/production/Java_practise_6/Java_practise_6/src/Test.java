...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println(); //merge сортировка
    ...
    public static void qSort(Object[] array, int high, int low) {
        ...
        Object middle = array[(low + high) / 2]; //Делим массив
    ...
    public static void mergeSort(Student[] a, int n) { //Сортировка
        if (n < 2) {
            return;
        }
        int mid = n / 2;
    ...
    public static void merge( //Слияиие
